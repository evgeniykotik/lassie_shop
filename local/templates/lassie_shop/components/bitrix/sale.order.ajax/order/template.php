    ...
    <main class="content order-page">
        <div class="container">
            ...
            <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM"
                  class="form js-form-validate order-page__form" id="bx-soa-order-form" enctype="multipart/form-data">
                <fieldset class="form__fieldset">
                    <legend class="form__title">Информация о покупателе</legend>
                    <div class="form__row">
                        <div class="form__col form__col_width_220">
                            <label for="order-name"
                                   class="form__label"><?= $arResult['USER_CONSENT_PROPERTY_DATA'][0] ?></label>
                        </div>
                    ...
                    <div class="form__row">
                        <div class="form__col form__col_width_220">
                            <label for="order-mail"
                                   class="form__label"><?= $arResult['USER_CONSENT_PROPERTY_DATA'][1] ?></label>
                        </div>
                    ...
                    <div class="form__row">
                        <div class="form__col form__col_width_220">
                            <label for="order-phone"
                                   class="form__label"><?= $arResult['USER_CONSENT_PROPERTY_DATA'][2] ?></label>
                        </div>
                        <div class="form__col form__col_width_260">
                    ...
                    <div class="form__row">
                        <div class="form__col form__col_width_220">
                            <label for="order-city"
                                   class="form__label"><?= $arResult['USER_CONSENT_PROPERTY_DATA'][5] ?></label>
                        </div>
                        <div class="form__col form__col_width_260">
                    ...
                    <div class="form__row form__row_direction_column">
                        <? foreach ($arResult["DELIVERY"] as $val): ?>
                            ...
                            <div class="form__checkbox-group">
                                <div class="checkbox">
                                    <input id="order-delivery-2" name="Order[delivery]" type="checkbox" value="DPD"
                                           required class="checkbox__elem">
                                    <label for="order-delivery-2"
                                           class="checkbox__label form__label"><?= $val["NAME"] ?></label>
                                </div>
                                    ...
                                    <div class="goods-table__cell">
                                        <div class="goods-table__col">
                                            <div class="goods-table__img-wrapper">
                                                <img src="<?= $val["DETAIL_PICTURE_SRC"] ?>" alt=""
                ...
                <div class="form__total">
                    <div class="form__col-right">
                        <div class="form__total-row form__total-row_goods-cost"><span class="form__total-item">Товаров на сумму:</span><span
                                    class="form__total-item">><?= $arResult["JS_DATA"]["TOTAL"]["ORDER_TOTAL_PRICE"] ?></span>
                        </div>
                        <div class="form__total-row form__total-row_general"><span class="form__total-item">Итого</span>
                            <div class="form__total-item form__total-item_sum">
                                ><?= $arResult["JS_DATA"]["TOTAL"]["PRICE_WITHOUT_DISCOUNT"] ?></div>
                        </div>
    ...
    <div style="display: none">
        <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM"
            ...
            <div id="bx-soa-order" class="row" style="opacity: 0">
                <!--	MAIN BLOCK	-->
                <div class="col-lg-8 col-md-7 bx-soa" style="display: none">
